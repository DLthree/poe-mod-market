...
//
// It lives here rather than in the sweep because the collection query and the
// link the page hands a person have to ask for the same item. They did not, and
// the link returned part-used tablets under prices that had excluded them.
