...
export async function sweepAffixes ({ client, db, index, league, types, rarities, perCell,
  ...
  for (const type of types) {
    for (const rarity of rarities) {
      ...
      // The vocabulary would be empty anyway — but an explicit `affixes` list
      // skips the vocabulary, and would happily spend a search per modifier
      // asking about tablets that cannot carry one.
